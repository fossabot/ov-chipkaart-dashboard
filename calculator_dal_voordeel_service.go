...
func (result *NSDalVoordeelCalculatorResult) addPeakJourneyPrice(journey NSJourneyPrice) {
	result.PeakFirstClassPrice = result.PeakFirstClassPrice.AddAmount(journey.FirstClassSingleFarePrice)
	result.PeakSecondClassPrice = result.PeakSecondClassPrice.AddAmount(journey.SecondClassSingleFarePrice)
